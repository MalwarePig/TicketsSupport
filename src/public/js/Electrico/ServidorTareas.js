...
function ActualizarTareas() {
    ...
    $.post("/ActualizarTareasElectrico", // url
        {
            Registro
        }, // data to be submit
        function (objeto, estatus) { // success callback
           window.location.href = "/ListaServicioElectrico";
        }); 
}
...
function MostrarProyectos() {
    ...
    $.ajax({
        url: '/TareasAbiertasServidorElectrico/' + localStorage.getItem('Nomina'),
    ...
    alert.buttons = [
        {
            text: 'Cancelar',
            role: 'cancel',
            handler: () => { CerrarModalEstatusElectrico(); }
        },
        {
            text: 'OK',
            role: 'confirm',
            handler: () => {  CerrarTareasElectrico(); }
        }
    ];
...
function CerrarTareasElectrico() {  
    ...
    $.post("/CerrarTareasElectrico", // url
        {
            Registro
        }, // data to be submit
        function (objeto, estatus) { // success callback
